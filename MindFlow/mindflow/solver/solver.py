...
class Solver:
    ...
    Args:
        ...
        amp_level (str): Option for argument `level` in `mindspore.amp.build_train_network
            <https://www.mindspore.cn/docs/zh-CN/r2.0.0-alpha/api_python/amp/mindspore.amp.build_train_network.html
            #mindspore.amp.build_train_network>`_ , level for mixed
            ...
            can be found at `mindspore.amp.build_train_network <https://www.mindspore.cn/docs/zh-CN/r2.0.0-alpha/
            api_python/amp/mindspore.amp.build_train_network.html#mindspore.amp.build_train_network>`_ .
