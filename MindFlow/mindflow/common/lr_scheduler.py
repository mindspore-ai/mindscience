...
from ..utils.check_func import check_lr_param_type_value
...
class LearningRate(LearningRateSchedule):
    ...
    Examples:
        >>> from mindflow.common import LearningRate
        >>> from mindspore.common.tensor import Tensor
        >>> from mindspore.common import dtype as mstype
    ...
    def __init__(self, learning_rate, end_learning_rate, warmup_steps, decay_steps, power):
        ...
        check_lr_param_type_value(learning_rate, "learning_rate", float, thresh_hold=0.0, restrict=True)
        check_lr_param_type_value(end_learning_rate, "end_learning_rate", float, thresh_hold=0.0, restrict=False)
        check_lr_param_type_value(warmup_steps, "warmup_steps", int, thresh_hold=0, restrict=False, exclude=bool)
        check_lr_param_type_value(decay_steps, "decay_steps", int, thresh_hold=0, restrict=True, exclude=bool)
        check_lr_param_type_value(power, "power", float, thresh_hold=0.0, restrict=True)
