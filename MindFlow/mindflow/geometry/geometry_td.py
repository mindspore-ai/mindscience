...
class TimeDomain(Interval):
    ...
    Examples:
        ...
        >>> from mindflow.geometry import create_config_from_edict, TimeDomain
        >>> time_config = edict({
        ...     'domain': edict({
...
class GeometryWithTime(Geometry):
    ...
    Examples:
        >>> from easydict import EasyDict as edict
        >>> from mindflow.geometry import create_config_from_edict, Rectangle, TimeDomain, GeometryWithTime
