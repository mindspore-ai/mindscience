...
class SpectralConv1dDft(nn.Cell):
    ...
    def __init__(self,
        ...
        if out_channels <= 0:
            raise ValueError(f"'out_channels' must be a positive integer, but got {out_channels}")
    ...
    @staticmethod
    def mul1d(inputs: Tensor, weights: Tensor) -> Tensor:
...
class SpectralConv2dDft(nn.Cell):
    ...
    @staticmethod
    def mul2d(inputs: Tensor, weights: Tensor) -> Tensor:
        r"""Complex multiplication."""
...
class SpectralConv3d(nn.Cell):
    ...
    def mul3d(self, inputs: Tensor, weights: Tensor) -> Tensor:
        r"""Complex multiplication."""
        weight = weights.expand_dims(0)
        data = inputs.expand_dims(2)
        out = weight * data
