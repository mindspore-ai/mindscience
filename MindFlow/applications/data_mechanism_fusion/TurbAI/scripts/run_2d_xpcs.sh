...
echo "For example: bash run_2d_16pcs.sh /path/rank_table.json 16 0 ./dataset/experiment/changeCondition_20230605163432"
...
do
  ...
  env > env$i.log
  nohup python train_2d.py --config_file_path="./configs/TurbAI_2D_MLP.yaml" > train$i.log 2>&1 &
done
...
env > env$i.log
python python train_2d.py --config_file_path="./configs/TurbAI_2D_MLP.yaml"
