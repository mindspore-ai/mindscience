...
# ============================================================================
"""Tests for vibescience_config module."""
import pytest
import tempfile
import os
...
from vibescience_agent.config.tool_config import PaperSurveyConfig
from vibescience_agent.config.log_config import LogConfig


class TestVibeScienceConfig:
    """Test cases for VibeScienceConfig."""
    ...
    def test_creation_with_values(self):
        """Test creating VibeScienceConfig with custom values."""
    ...
    def test_parse_model_config(self):
        ...
        model_config = VibeScienceConfig._parse_model_config(data)
    ...
    def test_parse_agent_config_with_defaults(self):
        ...
        agent_config = VibeScienceConfig._parse_agent_config(
    ...
    def test_parse_tool_config_paper_survey(self):
        ...
        tool_config = VibeScienceConfig._parse_tool_config("paper_survey", data)
    ...
    def test_parse_tool_config_unknown(self):
        ...
        tool_config = VibeScienceConfig._parse_tool_config("unknown_tool", data)
    ...
    def test_parse_log_config(self):
        ...
        log_config = VibeScienceConfig._parse_log_config(data)
    ...
    def test_get_agent_config_existing(self):
        ...
        config = VibeScienceConfig(agents={"survey": agent_config})
...
"""
    ...
    def test_init_config_from_yaml_file_not_found(self):
        ...
        with pytest.raises(ValueError, match="Config file not found"):
            config = VibeScienceConfig.init_config_from_yaml("/non/existent/path.yaml")
    ...
    def test_get_config_dict(self):
        ...
        config = VibeScienceConfig(model_defaults=model_config)
