...
execute_process(
        ...
        WORKING_DIRECTORY ${CPACK_PACKAGE_DIRECTORY}/../package/mindearth
        ERROR_QUIET)
...
if((PYTHON_VERSION MATCHES "3.9") OR (PYTHON_VERSION MATCHES "3.8") OR (PYTHON_VERSION MATCHES "3.7"))
    ...
    message("Could not find 'Python 3.10' OR 'Python 3.9' OR 'Python 3.8' or 'Python 3.7'")
    return()
endif()
...
file(WRITE ${CPACK_PACKAGE_DIRECTORY}/../package/mindearth/build_info.txt "${BUILD_DATE_TIME}\n${GIT_COMMIT_ID}")
