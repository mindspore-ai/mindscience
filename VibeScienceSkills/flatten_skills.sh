...
# flatten_skills.sh - 将VibeScienceSkills中的skills平铺到新目录
#
# 用法:
...
# 默认目标目录：和VibeScienceSkills平级的VibeScienceSkills_flattened
TARGET_DIR="$(dirname "$SOURCE_DIR")/VibeScienceSkills_flattened"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "选项:"
            echo "  -o, --output DIR    指定输出目录 (默认: ../VibeScienceSkills_flattened)"
            echo "  -h, --help          显示帮助"
            echo ""
            echo "示例:"
