...
- Example skills: See any skill in a given directory (e.g., `VibeScienceSkills/esm`, `VibeScienceSkills/transformers`, `VibeScienceSkills/diffdock`)
- Reference: `VibeScienceSkills/research_tools/general_tools/skill-creator/SKILL.md` for general skill creation patterns