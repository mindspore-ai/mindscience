...
import mindspore
from mindspore import context, nn, ops, jit, set_seed, load_checkpoint, load_param_into_net, save_checkpoint
...
def parse_args():
    ...
    parser.add_argument("--config_file_path", type=str,
                        default="./configs/taylor_green_2D.yaml")
...
def train():
    ...
    save_checkpoint(model,'taylor_green.ckpt')
