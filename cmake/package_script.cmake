...
if(NOT (${PYTHON_VERSION} VERSION_GREATER_EQUAL "3.7.0" AND ${PYTHON_VERSION} VERSION_LESS_EQUAL "3.11.9"))
    message(FATAL_ERROR "Found Python version ${PYTHON_VERSION}, but only versions 3.7 - 3.11 are supported.")
endif()
...
elseif(CMAKE_SYSTEM_NAME MATCHES "Windows")
    ...
    message("Only Linux and Windows platform are supported.")
endif()

# get the current timestamp to be embedded in the built info
string(TIMESTAMP BUILD_DATE_TIME "whl generated on:%Y-%m-%d %H:%M:%S")
file(WRITE ${CPACK_PACKAGE_DIRECTORY}/../package/mindscience/build_info.txt "${BUILD_DATE_TIME}\n${GIT_COMMIT_ID}")
