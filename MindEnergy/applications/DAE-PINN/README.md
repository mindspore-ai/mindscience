...
Download the dataset from the [link](https://download.mindspore.cn/mindscience/mindenergy/dataset/applications/DAE-PINN/) and extract it to the `DAE-PINN/data` directory. The directory structure of the dataset is as follows:
...
<div align="center">
    <img src="images/loss.png" width=60%>
</div>

The L2 relative loss predicted by the network for 4 dynamic and 1 algebraic variable is shown in the following figure:

<div align="center">
    <img src="images/L2relative_error_0.png" width=30%>
    <img src="images/L2relative_error_1.png" width=30%>
</div>
<div align="center">
    <img src="images/L2relative_error_2.png" width=30%>
    <img src="images/L2relative_error_3.png" width=30%>
    <img src="images/L2relative_error_4.png" width=30%>
</div>
