...
from mindscience import FNO1D, FNO2D, FNO3D
from mindscience.models.neural_operator.fno_sp import SpectralConv1dDft, SpectralConv2dDft, SpectralConv3dDft

RTOL = 0.001
set_seed(123456)

test_data_path = '/home/workspace/mindspore_dataset/mindscience/fno'
...
def test_spectralconvdft_output():
    ...
    param1 = load_checkpoint(os.path.join(test_data_path, "spectralconv1d.ckpt"))
    param2 = load_checkpoint(os.path.join(test_data_path, "spectralconv2d.ckpt"))
    param3 = load_checkpoint(os.path.join(test_data_path, "spectralconv3d.ckpt"))
