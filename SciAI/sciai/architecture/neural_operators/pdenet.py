...
from sciai.architecture.neural_operators.m2k import _M2K
...
class PDENet(nn.Cell):
    ...
    Examples:
        ...
        >>> from sciai.architecture.neural_operators import PDENet
    ...
    def __init__(self,
        ...
        """Initialize PDE-Net."""
        super().__init__()
        _check_type(height, "height", target_type=int)
        _check_type(width, "width", target_type=int)
        _check_type(channels, "channels", target_type=int)
        _check_type(kernel_size, "kernel_size", target_type=int)
        _check_type(max_order, "max_order", target_type=int)
        _check_type(periodic, "periodic", target_type=bool)
        _check_type(enable_moment, "enable_moment", target_type=bool)
        _check_type(if_fronzen, "if_fronzen", target_type=bool)
        self.in_c = channels
        self.out_c = channels
