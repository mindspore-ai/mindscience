...
# ============================================================================
"""
Batch dot product operations for tensor computations.

This module provides utilities for performing batch-wise dot products
between tensors with support for various axis configurations.
"""
...
def batch_dot(x1, x2, axes=None):
    """
    Compute batch-wise dot product of two tensors.

    Args:
        x1 (Tensor): First input tensor with shape (batch_size, ...).
        x2 (Tensor): Second input tensor with shape (batch_size, ...).
        axes (int, list, tuple, optional): Axes to perform dot product along.
