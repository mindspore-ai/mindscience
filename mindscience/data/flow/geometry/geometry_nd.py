...
class FixedPoint(Geometry):
    ...
    Args:
        ...
        coord (Union[int, float, tuple, list, numpy.ndarray]): Coordinate of the fixed point. If the parameter
            type is tuple or list, each element should be of type int or float.
