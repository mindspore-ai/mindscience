...
class CreateDataset:
    ...
    def __init__(self, name, path,
                 ...
                 lattice_scale_method, config_data_path,
                 num_samples=None):
        super().__init__()
        self.path = path
        self.name = name
        ...
        self.config = load_yaml_config_from_path(config_data_path).get("Encoder")
...
def create_dataset(args):
    ...
    val_dataset = CreateDataset("Formation energy val", path_val, prop,
                                niggli, primitive, graph_method,
                                preprocess_workers, lattice_scale_method,
                                config_path, args.num_samples_val)
    ...
    test_dataset = CreateDataset("Formation energy test", path_test, prop,
                                 niggli, primitive, graph_method,
                                 preprocess_workers, lattice_scale_method,
                                 config_path, args.num_samples_test)
