...
def train_net(args):
    ...
    # create dataset when runing the model first-time or when dataset is not exist
...
def get_args():
    ...
    parser.add_argument("--num_samples_train", default=-1, type=int,
                        help="number of samples for training,\
                        only valid when create_dataset is True")
    parser.add_argument("--num_samples_val", default=-1, type=int,
