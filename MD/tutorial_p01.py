...
# 
# MindSPONGE tutorial protein 01: Load PDB file and minimization.
...
parser.add_argument("-m", help="Set the compile mode.", default="1")
...
system = Protein(pdb='../pdb/case1.pdb', rebuild_hydrogen=True)
