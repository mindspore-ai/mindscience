...
def fullconnect_dataset(name,
    ...
    for idx in range(len(cached_data)):
        ...
        (frac_coords, atom_types, lengths, angles, lattice_polar, _, _, num_atoms) = data_dict['graph_arrays']
        ...
        lattice_polar_list.append(lattice_polar)
    ...
    return x, frac_coord_list, edge_attr, edge_index, lengths_list, \
        angles_list, lattice_polar_list, num_atoms_list, labels
