...
class CSPLayer(nn.Cell):
    ...
    def __init__(self, hidden_dim=512, act_fn=nn.SiLU(), dis_emb=None):
        ...
        self.edge_mlp = nn.SequentialCell([
            nn.Dense(hidden_dim * 2 + 6 + self.dis_dim, hidden_dim), act_fn,
    ...
    def edge_model(self, node_features, lattice_polar, edge_index,
    ...
    def construct(self, node_features, lattice_polar, edge_index,
        ...
        edge_features = self.edge_model(node_features, lattice_polar,
...
class CSPNet(nn.Cell):
    ...
    def construct(self, t, atom_types, frac_coords, lattice_polar, node2graph,
                  edge_index, node_mask, edge_mask, cemb):
        ...
        graph_features = self.node_scatter(node_features,
                                           node2graph,
                                           dim_size=lattice_polar.shape[0],
                                           mask=node_mask)
