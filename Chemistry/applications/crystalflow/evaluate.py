...
def flow(loader, model, num_evals, n, anneal_slope, anneal_offset):
    ...
    # 【修改】：使用 enumerate 包装 loader，因为原生的 loader.step 已经不可用
    for step_idx, (atom_types_step, frac_coords_step, _, lengths_step, \
        ...
        # 【修改】：因为 batch_size_step 是 Tensor，所以必须取出真实的 int 数值
...
def main(args):
    ...
    # 和 CrystalFlow 的 Crysloader yield 的 14 个输出顺序一一对应
    column_names = [
