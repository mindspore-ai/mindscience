...
class CSPFlow(nn.Cell):
    ...
    def construct(self, batch_num_graphs, batch_atom_types, batch_lengths,
                  batch_lattice_polar, batch_frac_coords, batch_node2graph,
                  batch_edge_index, node_mask, edge_mask, condition):
        ...
        lattice_polar_0 = self.lattice_model.sample_numpy(batch_lengths.shape[0], self.sigma)
