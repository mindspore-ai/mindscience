...
.. py:class:: mindscience.e3nn.o3.Linear(irreps_in, irreps_out, ncon_dtype=float32, **kwargs)

    线性等变操作。
    等效于"instructions='linear'"的"TensorProduct'"。有关详细信息，请参阅 :class:`mindscience.e3nn.o3.TensorProduct`。
