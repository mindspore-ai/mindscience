...
.. py:class:: mindscience.e3nn.o3.LinearBias(irreps_in, irreps_out, has_bias, ncon_dtype=float32, **kwargs)

    具有添加偏置选项的线性等变操作。
    等效于"instructions='linear'"的"TensorProduct"，带有添加偏差的选项。关于细节，请参阅 :class:`mindscience.e3nn.o3.TensorProduct`。
