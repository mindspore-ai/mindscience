.. py:class:: mindflow.pde.Problem
    ...
    .. py:method:: boundary_condition(*output, **kwargs)
    ...
    .. py:method:: constraint_function(*output, **kwargs)
    ...
    .. py:method:: governing_equation(*output, **kwargs)
    ...
    .. py:method:: initial_condition(*output, **kwargs)
