...
.. py:class:: mindflow.cell.ConditionDiffusionTransformer(in_channels, out_channels, cond_channels, hidden_channels, cond_channels, layers, heads, time_token_cond=True, compute_dtype=mstype.float32)
