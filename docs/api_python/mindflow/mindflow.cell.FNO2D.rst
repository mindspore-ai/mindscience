.. py:class:: mindflow.cell.FNO2D(in_channels, out_channels, resolution, modes, channels=20, depths=4, mlp_ratio=4, compute_dtype=mstype.float32)
    ...
    输出：
        ...
        - **output** (Tensor) - shape为 :math:`(batch\_size, resolution, input\_dims)` 的Tensor。
