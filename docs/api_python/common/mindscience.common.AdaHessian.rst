...
.. py:class:: mindscience.common.AdaHessian(params, learning_rate=1e-3, beta1=0.9, beta2=0.999, eps=1e-8, use_locking=False, use_nesterov=False, weight_decay=0.0, loss_scale=1.0, use_amsgrad=False, **kwargs)
    ...
    此处 Hessian power 固定为 1，且对 Hessian 对角元做空间平均的方法如下：
