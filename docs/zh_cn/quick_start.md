...
随着神经网络的迅猛发展，基于神经网络的方法为科学计算提供了新的范式。mindscience 套件为这种新的计算范式提供了多种工具与接口，其中就包括了针对数值求解偏微分方程的算子神经网络。接下来，我们选取流体力学中最经典与简单的案例——求解一维情形下的 Burgers 方程作为示例，来介绍 mindscience 套件的部分接口与使用方式。
