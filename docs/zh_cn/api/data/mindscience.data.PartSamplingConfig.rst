mindscience.data.PartSamplingConfig
======================================

.. py:class:: mindscience.data.PartSamplingConfig(size, random_sampling=True, sampler="uniform", random_merge=True, with_normal=False, with_sdf=False)
