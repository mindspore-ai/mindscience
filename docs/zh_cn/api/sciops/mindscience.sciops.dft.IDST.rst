...
.. py:class:: mindscience.sciops.dft.IDST(shape, compute_dtype=mstype.float32)

    在最后一个轴上对实数进行 1D 离散正弦逆变换。结果应与 `scipy.fft.dct() <https://docs.scipy.org/doc/scipy/reference/generated/scipy.fft.dct.html#scipy.fft.dct>`_ 相同。
