...
.. py:class:: mindscience.diffuser.DiffusionTrainer(model, scheduler, objective='pred_noise', p2_loss_weight_gamma=0., p2_loss_weight_k=1.0, loss_type='l1')
    ...
    参数：
        ...
        - **p2_loss_weight_k** (float, 可选) - p2 损失权重中的 k 参数，具体信息查看 `Perception Prioritized Training of Diffusion Models <https://arxiv.org/abs/2204.00227>`_ 。默认 ``1.0``。
