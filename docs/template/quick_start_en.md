# FNO operator for solving 1-D Burgers equation
...
The 1D Burgers’ equation is a non-linear PDE with various applications including modeling the one-dimensional flow of a viscous fluid. It takes the form
...
where $u$ is the velocity field, $u_0$ is the initial condition and $\nu$ is the viscosity coefficient. We aim to learn the operator that maps the initial condition to the solution at time 1:
...
![Fourier Neural Operator model structure](https://raw.gitcode.com/mindspore-lab/mindscience/raw/master/MindFlow/applications/data_driven/burgers/fno1d/images/FNO.png)
...
![Fourier Layer structure](https://raw.gitcode.com/mindspore-lab/mindscience/raw/master/MindFlow/applications/data_driven/burgers/fno1d/images/FNO-2.png)
...
You can run the training and validation code line by line using the Chinese or English version of the Jupyter Notebook [Chinese Version](https://atomgit.com/mindspore-lab/mindscience/blob/master/MindFlow/applications/data_driven/burgers/fno1d/FNO1D_CN.ipynb) and [English Version](https://atomgit.com/mindspore-lab/mindscience/blob/master/MindFlow/applications/data_driven/burgers/fno1d/FNO1D.ipynb).

#### Results Display

![FNO1D Solves Burgers Equation](https://raw.gitcode.com/mindspore-lab/mindscience/raw/master/MindFlow/applications/data_driven/burgers/fno1d/images/101-result.jpg)
...
| Evaluation Config                | batch_size=8          |
| Optimizer                  | Adam                 |
