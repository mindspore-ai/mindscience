...
#ifndef MINDELEC_CCSRC_API_PYTHON_PYBIND_REGISTER_H_
#define MINDELEC_CCSRC_API_PYTHON_PYBIND_REGISTER_H_
...
#endif  // MINDELEC_CCSRC_API_PYTHON_PYBIND_REGISTER_H_
