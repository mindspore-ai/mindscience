...
def vtk_structure(grid_tensor, eh_tensor, path_res):
    ...
    Args:
        grid_tensor (numpy.ndarray): grid data, shape: :math:`(dim_t, dim_x, dim_y, dim_z, 4)`.
        eh_tensor (numpy.ndarray): electric and magnetic data, np.array, shape: :math:`(dim_t, dim_x, dim_y, dim_z, 6)`.
