...
class EvalCallback():
    ...
    def __init__(self, net, input_shape, anchors, anchors_mask, class_names, num_classes, val_lines, log_dir,
                 map_out_path=".temp_map_out_v2", max_boxes=100, confidence=0.05, nms_iou=0.5, letterbox_image=True,
    ...
    def get_map_txt(self, image_id, image, class_names, map_out_path):
        ...
        outputs = self.bbox_util.decode_box((output,))
