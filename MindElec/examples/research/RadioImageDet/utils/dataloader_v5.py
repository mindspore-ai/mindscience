...
class YoloDataset():
    ...
    def __getitem__(self, index):
        ...
        y_true0, y_true1, y_true2 = self.get_target(box)
        return image, box, y_true0, y_true1, y_true2
...
def yolo_dataset_collate(image, boxes, y_true0, y_true1, y_true2, _):
    images = {"images": image}
    bboxes = {"bboxes": boxes}
    y_trues0 = {"y_trues0": y_true0}
    y_trues1 = {"y_trues1": y_true1}
    y_trues2 = {"y_trues2": y_true2}

    return images, bboxes, y_trues0, y_trues1, y_trues2
