...
from nets.yolo_v2 import YoloBody
from nets.yolo_training import YOLOLoss
from utils.callbacks_v2 import EvalCallback, LossHistory
from utils.dataloader_v2 import YoloDataset, yolo_dataset_collate
...
if __name__ == "__main__":
    ...
    anchors_path = 'model_data/yolo_anchors_v2.txt'  # anchors path
    anchors_mask = [[0, 1, 2, 3, 4]]
    ...
    save_dir = 'logs_v2'  # The folder where weights and log files are saved
    ...
    for epoch in range(init_epoch, unfreeze_epoch):
        ...
        def forward_fn(images, targets, y_trues):
            ...
            loss_value_all = 0
            loss_item = yolo_loss(0, outputs, targets, y_trues[0])
