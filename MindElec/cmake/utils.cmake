...
if(DEFINED ENV{MDLIBS_CACHE_PATH})
    set(_MD_LIB_CACHE  $ENV{MDLIBS_CACHE_PATH})
else()
    set(_MD_LIB_CACHE ${CMAKE_BINARY_DIR}/.mdlib)
endif()
message("MD LIBS CACHE PATH:  ${_MD_LIB_CACHE}")

if(NOT EXISTS ${_MD_LIB_CACHE})
    file(MAKE_DIRECTORY ${_MD_LIB_CACHE})
endif()
...
function(__check_patches pkg_patches)
    # check patches
    if(PKG_PATCHES)
        file(TOUCH ${_MD_LIB_CACHE}/${pkg_name}_patch.md5)
        file(READ ${_MD_LIB_CACHE}/${pkg_name}_patch.md5 ${pkg_name}_PATCHES_MD5)
        ...
        if(NOT ${pkg_name}_PATCHES_MD5 STREQUAL ${pkg_name}_PATCHES_NEW_MD5)
            ...
            file(REMOVE_RECURSE "${_MD_LIB_CACHE}/${pkg_name}-subbuild")
            file(WRITE ${_MD_LIB_CACHE}/${pkg_name}_patch.md5 ${${pkg_name}_PATCHES_NEW_MD5})
...
function(mindspore_add_pkg pkg_name)
    ...
    set(options)
    set(oneValueArgs
            URL MD5 GIT_REPOSITORY GIT_TAG VER EXE DIR SUB_DIR HEAD_ONLY CMAKE_PATH RELEASE LIB_PATH CUSTOM_CMAKE)
    set(multiValueArgs
    ...
    set(${pkg_name}_BASE_DIR ${_MD_LIB_CACHE}/${pkg_name}_${${pkg_name}_CONFIG_HASH})
    ...
    if(NOT PKG_DIR)
        ...
        if(PKG_SUB_DIR)
            set(${pkg_name}_SOURCE_DIR ${${pkg_name}_SOURCE_DIR}/${PKG_SUB_DIR})
        endif()
