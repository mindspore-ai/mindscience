...
from .module.structure import ContactStructureModule
from ..megafold.module.head import DistogramHead, ExperimentallyResolvedHead, MaskedMsaHead, \
...
class Rasp(nn.Cell):
    ...
    def __init__(self, config, mixed_precision):
        ...
        self.structure_module = ContactStructureModule(self.cfg, \
