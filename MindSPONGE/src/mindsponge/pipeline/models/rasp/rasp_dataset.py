...
from ..megafold.megafold_data import correct_restypes, make_atom14_mask, tail_process, \
...
from .rasp_data import contact_info
from .rasp_feature import _msa_feature_names, _inference_feature, _training_feature
from ...dataset import PSP, data_process_run


class RASPDataSet(PSP):
    "MEGAFoldDataSet"

    def __init__(self, config, seed=0):
        self.config = config
        self.supported_models = ['RASP']
        ...
        self.data_process = [
            ...
            make_atom14_mask,
            contact_info(self.config.contact_path)]
        template_process = [
