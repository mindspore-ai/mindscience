...
class Tox21(data.MolSet):
    ...
    def __init__(self, path, verbose=1, batch_size=128, **kwargs):
        super().__init__(batch_size=batch_size, verbose=verbose, **kwargs)
    ...
    def load(self, **kwargs):
        """load"""
        zip_file = util.download(self.url, self.path, md5=self.md5)
        csv_file = util.extract(zip_file)
