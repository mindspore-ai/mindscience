...
from ..layers import SumAggregation, MeanAggregation, NeuralFingerprintConv
from .. import core


class NeuralFingerprint(core.Cell):
    """
    ...
    def __init__(self, input_dim, output_dim, hidden_dims, edge_input_dim=None, short_cut=False, batch_norm=False,
        ...
        for i in range(len(self.dims) - 1):
            ...
            self.linears.append(nn.Dense(self.dims[i + 1], output_dim))
