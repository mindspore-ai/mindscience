...
class Molecule(Cell):
    ...
    def fill_water(self, edge: float = None, gap: float = 4.0, box: ndarray = None, pdb_out: str = None,
                   template: str = None):
        """ The inner function in Molecule class to add water in a given box.
        Args:
            edge(float): The water edge around the system, the unit is A.
            gap(float): The minimum gap between system atoms and water atoms, the unit is A.
            box(Tensor): The pbc box we want, default to be None, the length unit is A.
