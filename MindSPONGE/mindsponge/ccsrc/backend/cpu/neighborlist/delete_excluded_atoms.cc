...
static void Delete_Excluded_Atoms(const int atom_numbers, const int max_neighbor_numbers,
...
extern "C" int DeleteExcludedAtoms(int nparam, void **params, int *ndims, int64_t **shapes,
  ...
  Delete_Excluded_Atoms(atom_number, max_neighbor_numbers, excluded_list_start, excluded_list,
    excluded_numbers, nl_atom_numbers, nl_atom_serial);
