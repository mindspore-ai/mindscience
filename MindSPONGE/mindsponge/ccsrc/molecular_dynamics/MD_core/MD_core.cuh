...
struct MD_INFORMATION
{
    ...
    float dt = 0.001 * CONSTANT_TIME_CONVERTION;//模拟步长，单位为(0.0488878 ps)==(1/20.455 ps)
    ...
    struct residue_information
    {
        ...
        void Residue_Crd_Map(VECTOR *no_wrap_crd, float scaler = 1.0f); //将坐标质心映射到盒子中，且如果scaler>0则乘上scaler
