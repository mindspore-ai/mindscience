...
void SIMPLE_CONSTRAIN::Initial_Simple_Constrain(CONTROLLER *controller,
                                                CONSTRAIN *constrain,
...
void SIMPLE_CONSTRAIN::Remember_Last_Coordinates(VECTOR *crd,
...
void SIMPLE_CONSTRAIN::Constrain(VECTOR *crd, VECTOR *vel,
                                 const float *mass_inverse, const float *d_mass,
                                 VECTOR box_length, int need_pressure,
                                 float *d_pressure) {
  if (is_initialized) {
    //清空约束力和维里
