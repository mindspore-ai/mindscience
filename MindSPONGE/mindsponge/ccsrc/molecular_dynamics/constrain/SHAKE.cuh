...
struct SHAKE {
  ...
  void Initial_Simple_Constrain(CONTROLLER *controller, CONSTRAIN *constrain,
                                const char *module_name = NULL);

  //清除内存
  void Clear();
  //记录更新前的距离
  void Remember_Last_Coordinates(VECTOR *crd, UNSIGNED_INT_VECTOR *uint_crd,
                                 VECTOR scaler);
  //进行约束迭代
  void Constrain(VECTOR *crd, VECTOR *vel, const float *mass_inverse,
