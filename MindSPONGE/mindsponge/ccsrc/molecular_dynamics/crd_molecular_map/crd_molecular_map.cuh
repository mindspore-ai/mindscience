...
struct CoordinateMolecularMap {
  ...
  void Initial(int atom_numbers, VECTOR box_length, VECTOR *crd,
               const int exclude_numbers, const int *exclude_length,
               const int *exclude_start, const int *exclude_list,
  ...
  void Record_Box_Map_Times_Host(int atom_numbers, VECTOR *crd, VECTOR *old_crd,
                                 INT_VECTOR *box_map_times, VECTOR box);
