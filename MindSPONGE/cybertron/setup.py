...
package_name = os.getenv('CYBERTRON_PACKAGE_NAME').replace("\n", "")
...
class EggInfo(egg_info):
    ...
    def run(self):
        super().run()
        egg_info_dir = os.path.join(cur_dir, 'cybertron.egg-info')
...
class BuildPy(build_py):
    ...
    def run(self):
        super().run()
        cybertron_dir = os.path.join(pkg_dir, 'libs', 'cybertron')
        update_permissions(cybertron_dir)
