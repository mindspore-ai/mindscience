...
- 🔥`2026.3.28` 基于MindSpore的Evo2-7b推理发布，支持单卡forward、embedding、generation推理能力，性能优化中。[[代码]](https://atomgit.com/mindspore-lab/mindscience/tree/master/MindSPONGE/research/Evo2)
...
- 🔥`2025.7.26` 基于MindSpore的DeepMind版AlphaFold3推理发布，性能持续提升中！[[代码]](https://atomgit.com/mindspore-lab/mindscience/tree/master/MindSPONGE/applications/AlphaFold3)
...
- `2023.5.31` NMR核磁共振动态蛋白质结构解析方法正式开源，详见论文Assisting and Accelerating NMR Assignment with Restrained Structure Prediction [[论文]](https://www.biorxiv.org/content/10.1101/2023.04.14.536890v1) [[代码]](https://atomgit.com/mindspore-lab/mindscience/tree/legacy-master/MindSPONGE/applications/research/FAAST)
...
- `2022.07.18` 论文"SPONGE: A GPU-Accelerated Molecular Dynamics Package with Enhanced Sampling and AI-Driven Algorithms"发表于期刊Chinese Journal of Chemistry。[[论文]](https://onlinelibrary.wiley.com/doi/epdf/10.1002/cjoc.202100456)
...
MindSPONGE分子动力学库 (MindSpore Simulation Package tOwards Next Generation molecular modelling)是
...
- MindSpore AI4S Lab团队: [longyangyang](https://atomgit.com/yanglong_unimelb), [Yuheng Wang](https://atomgit.com/wyhohyw)，[chendanyang](https://atomgit.com/birfied)，[Jinxl-pp](https://atomgit.com/xianlin_jin), [wangbo](https://atomgit.com/wangbo572)
