...
.. py:class:: mindsponge.optimizer.Updater(system, controller, time_step=1e-3, velocity, weight_decay=0.0, loss_scale=1.0)
    ...
    参数：
        ...
        - **time_step** (float) - 单步时间。
        - **velocity** (Tensor) - 速度。
        - **weight_decay** (float) - 权重衰减值。
        - **loss_scale** (float) - 误差比例。
    ...
    .. py:method:: update_kinetics(kinetics, success)
    ...
    .. py:method:: update_pressure(pressure, success)
    ...
    .. py:method:: update_temperature(temperature, success)
    ...
    .. py:method:: update_velocity(velocity, success)
    ...
    .. py:method:: update_virial(virial, success)
