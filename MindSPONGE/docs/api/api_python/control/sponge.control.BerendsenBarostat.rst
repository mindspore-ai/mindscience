...
.. py:class:: sponge.control.BerendsenBarostat(system: :class:`sponge.system.Molecule`, pressure: float = 1, anisotropic: bool = False, control_step: int = 1, compressibility: float = 4.6e-5, time_constant: float = 1., **kwargs)

    Berendsen(弱耦合)气压调节器，是 :class:`sponge.control.Barostat` 的子类。
    ...
    .. py:method:: set_time_step(dt)
        ...
        返回：
            :class:`sponge.control.BerendsenBarostat`，当前气压调节器。