...
.. py:class:: mindsponge.control.Barostat(system, pressure=1, anisotropic=False, control_step=1, compressibility=4.6e-5, time_constant=1)
    ...
    .. py:method:: pressure_scale(sim_press, ref_press, ratio=1)
