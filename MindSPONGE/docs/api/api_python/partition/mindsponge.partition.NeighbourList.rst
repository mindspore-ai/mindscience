...
.. py:class:: mindsponge.partition.NeighbourList(system, cutoff, update_steps=20, exclude_index, num_neighbours, num_cell_cut=1, cutoff_scale=1.2, cell_cap_scale=1.25, grid_num_scale=2, large_dis=1e4, use_grids)
    ...
    .. py:method:: calcaulate(coordinate, pbc_box)

        计算邻居列表。

        参数：
            - **coordinate** (Tensor) - 坐标。
            - **pbc_box** (Tensor) - PBC box。
