...
python run_inference.py scaffoldguided.target_path=examples/input_pdbs/insulin_target.pdb inference.output_prefix=example_outputs/design_ppi_scaffolded scaffoldguided.scaffoldguided=True 'ppi.hotspot_res=[A59,A83,A91]' scaffoldguided.target_pdb=True scaffoldguided.target_ss=examples/target_folds/insulin_target_ss.ms scaffoldguided.target_adj=examples/target_folds/insulin_target_adj.ms scaffoldguided.scaffold_dir=examples/ppi_scaffolds/ inference.num_designs=10 denoiser.noise_scale_ca=0 denoiser.noise_scale_frame=0
