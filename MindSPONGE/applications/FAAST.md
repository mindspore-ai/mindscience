...
下载RASP模型训练好的权重:[RASP.ckpt](<https://download.mindspore.cn/mindscience/mindsponge/FAAST/checkpoint/RASP.ckpt>)，相关运行示例文件可以在[样例文件](<https://download.mindspore.cn/mindscience/mindsponge/FAAST/example/>)下载，example文件夹放在./mindscience/MindSPONGE/applications/research/FAAST下，所有样例文件均需下载
运行以下命令启动推理。
...
python run_rasp.py \
    --run_platform 'Ascend' \
    --use_pkl False \
    --restraints_path '/mindscience/MindSPONGE/applications/research/FAAST/example/restraints' \
    --input_path '/mindscience/MindSPONGE/applications/research/FAAST/example/pkl' \
    --checkpoint_file '/mindscience/MindSPONGE/applications/research/FAAST/RASP.ckpt' \
    --use_template True \
    --use_custom False \
    --a3m_path '/mindscience/MindSPONGE/applications/research/FAAST/example/a3m' \
    --template_path '/mindscience/MindSPONGE/applications/research/FAAST/example/cif'
选项：
